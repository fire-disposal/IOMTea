...
export const AVATAR_PART_MANIFEST: AvatarPartManifestItem[] = [
  ...
  { id: 'face-shape', layer: 'face', description: 'Front-face geometry', styles: ['round', 'oval', 'square'] },
  { id: 'eyes', layer: 'eyes', description: 'Eye component', styles: ['round', 'almond', 'smile'] },
  { id: 'brows', layer: 'brows', description: 'Eyebrow component', styles: ['soft', 'flat', 'sharp'] },
  { id: 'nose', layer: 'nose', description: 'Nose component', styles: ['dot', 'small', 'long'] },
  { id: 'mouth', layer: 'mouth', description: 'Mouth component', styles: ['smile', 'neutral', 'laugh'] },
  { id: 'hair', layer: 'hair', description: 'Hair component', styles: ['short', 'long', 'buzz', 'curly'] },
  { id: 'glasses', layer: 'accessory', description: 'Glasses component', styles: ['none', 'round', 'square'] },
