...
Page({data:{},fi:0,cr:null,dt:null,cv:0,dwt:null,dwa:false,dws:0,cc:-1,pc:-1,locked:[],
  ...
  _lock(ci){if(this.locked[ci])return;this.locked[ci]=true;var cf=this.data.chainFields.slice();var f=cf[ci];if(f.type==='dial'){f.done=true;f.selIdx=1;f.selLabel=String(this.cv.toFixed(f.dec||0));this.setData({chainFields:cf,stl:1});var s=this;setTimeout(function(){s.setData({stl:2})},400);setTimeout(function(){s.setData({stl:3})},700)}
